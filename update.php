...
$query=mysqli_query($con,"select * from info where username='$username'");
...
$qua=implode(",",$chk);	
	if($img=="")
	{	
	$query="update info SET name='$n',email='$e',password='$pass',mobile='$m',address='$adds',gender='$gen',qualificaction='$qua',state='$state',dob='$dob' where user_id='$x'";
